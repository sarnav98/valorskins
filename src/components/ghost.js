    ...
    return (
      ...
      <section style={{backgroundColor: '#0a0a0a', width: '95%', margin: 'auto'}}>
        <Grid>
          ...
          <CardTitle style={{color: '#fe0468', height: '200px', background: 'url(https://raw.githubusercontent.com/thulka2/valorskins/master/src/displays/Ghost/ego-display.png) center'}}>
           Ego
          </CardTitle>
